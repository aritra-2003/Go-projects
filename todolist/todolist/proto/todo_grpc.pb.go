...
const (
	...
	TodoService_GetAISuggestions_FullMethodName = "/todo.TodoService/GetAISuggestions"
)
...
func (c *todoServiceClient) GetAISuggestions(ctx context.Context, in *AISuggestionsRequest, opts ...grpc.CallOption) (*AISuggestionsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(AISuggestionsResponse)
	err := c.cc.Invoke(ctx, TodoService_GetAISuggestions_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedTodoServiceServer) GetAISuggestions(context.Context, *AISuggestionsRequest) (*AISuggestionsResponse, error) {
...
func _TodoService_GetAISuggestions_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AISuggestionsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TodoServiceServer).GetAISuggestions(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TodoService_GetAISuggestions_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TodoServiceServer).GetAISuggestions(ctx, req.(*AISuggestionsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var TodoService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _TodoService_GetAISuggestions_Handler,
		},
	},
